	...
	<div class="container">
		...
		<section id="centro">
			<div class="content-panel mt-4" id="panelDatos">
				<h4><i class="fa fa-user"></i>Categorias
					<button class="btn btn-success btn-md ml-4" id="btnAgregar"><i class="fa fa-plus"></i>Agregar Categoria</button>
				</h4>
				<hr>
				<div id="contentTable">
					<div class="row mb-1">
...
<script type="text/javascript" src="<?php echo URL;?>public/js/categorias.js"></script>
</body>
</html>